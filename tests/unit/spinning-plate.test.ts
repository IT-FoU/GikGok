...
describe("Spinning Plate configuration and guide", () => {
  it("keeps twelve slots and published multipliers", () => {
    ...
    expect(PLATE_CONFIG.gameId).toBe("spinning_plate");
...
describe("Spinning Plate receipt, graphics, recovery", () => {
  it("parses payload and staging replay for refresh recovery", () => {
    ...
    expect(parsePlateServerResult({ game: "high_low" })).toBeNull();
  });
