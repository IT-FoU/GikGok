...
const nicknameSchema = z
  ...
  .max(NICKNAME_MAX, "Nickname must be at most 32 characters")
...
export const settingsUpdateSchema = z.object({
  ...
  fpsCap: z.union([z.literal(30), z.literal(45), z.literal(60), z.literal(120)]),
