...
export default async function LedgerPage({
  ...
  let query = supabase
    .from("ledger_entries")
    .select(
      "id, entry_type, amount, balance_after, reason, source_type, source_id, created_at, metadata",
    )
    ...
    <main className="mx-auto flex w-full max-w-4xl flex-col gap-6">
      <div>
        ...
        <p className="mt-2 text-sm text-[var(--brand-muted)]">
          Append-only demo-credit ledger. Balances are never edited directly.
        </p>
      </div>
